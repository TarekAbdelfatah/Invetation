...
namespace Ibtikar.Controllers
{
    ...
    public class CommitteeAdminController : Controller
    {
        private readonly ICommitteeFormationService _service;
        private readonly ILogger<CommitteeAdminController> _logger;

        public CommitteeAdminController(ICommitteeFormationService service, ILogger<CommitteeAdminController> logger)
        {
            _service = service;
            _logger = logger;
        }
